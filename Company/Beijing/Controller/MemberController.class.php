    ...
    public function index(){
...

		{
...

			{
				...
				$arr=$BeijingRolesStatus[$_SESSION["v_company_session"]]['group'];
...
//				}
	...
	if(!empty($nowuser['uid_role'])){
		...
		{		
			...
			$firstrolelarr=$BeijingGroups['Permissions']['订购产品'];
...

		{
			...
			$lastrolelarr=$BeijingGroups['Permissions']['总行审核'];
	...
	if($_POST){
		...
		//$adlist=$user->field("v_users.*")->where($where)->find();	
