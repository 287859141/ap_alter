...
<div class="portlet box blue">
      <div  class="portlet-title">
            <div class="caption" name='$ordersee'><i class="icon-reorder" ></i>库存产品</div>
                        <div class="tools">
                        </div>
			</div>  
        ...
        <table width="100%">
          <tr>
                   ...
                   <!--  <TD colspan="20" height="40" align="right">
                    <input type="button" id="button"  onClick="together()" value="出库选中的产品" style="height:25px;width:200px">&nbsp;&nbsp;<input type="hidden" id="ordertype" value="<?php echo ($ordertype); ?>"/><input type="hidden" id="idlist" name="idlist" /><input type="hidden" id="idvar" name="idvar" /><input type="hidden" name="amountkc" id="amountkc"/>
                    </TD>  -->
                   </tr>
                   <tr height="45" style=" font-family:'微软雅黑'; font-size:14px; font-weight:500; color:#557abb;">
                           ...
                           <td width="8%" style="text-align:center">库存数量</td>
						   <td width="8%" style="text-align:center">单位</td>
                           <td width="12%" style="text-align:center">库存金额</td>
                           <td width="15%" style="text-align:center">包装规格</td>
						    <td width="12%" style="text-align:center">操作</td>
                   </tr>
				   	   <tr height="45" style=" font-family:'微软雅黑'; font-size:14px; font-weight:500; color:#557abb;">
				 
                           <td width="8%" style="text-align:center">bjb-1-027</td>
                           <td width="24%" style="text-align:center">对公表外付出传票</td>
                           <td width="5%" style="text-align:center">常用凭证</td>
                           <td width="8%" style="text-align:center">10</td>
                         <td width="8%" style="text-align:center">包</td>
                           <td width="12%" style="text-align:center">300</td>
                           <td width="15%" style="text-align:center">1包 × 100本 × 25份</td>
						    <td width="12%" style="text-align:center"><a  href="#">编辑</a> 
                                               <a href="#" >删除</a></td>
                   </tr>
				    <tr height="45" style=" font-family:'微软雅黑'; font-size:14px; font-weight:500; color:#557abb;">
				
                           <td width="8%" style="text-align:center">bjb-1-008</td>
                           <td width="24%" style="text-align:center">企业电子银行查询服务申请书</td>
                           <td width="5%" style="text-align:center">常用凭证</td>
                           <td width="8%" style="text-align:center">10</td>
                      <td width="8%" style="text-align:center">包</td>
                           <td width="12%" style="text-align:center">1560</td>
                           <td width="15%" style="text-align:center">1包 × 100本 × 25份</td>
						    <td width="12%" style="text-align:center"><a  href="#">编辑</a> 
                                               <a href="#" >删除</a></td>
                   </tr>
