            ...
            <div class="row-fluid">
                <div class="span12">	
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="#">新提交订单</a></li>
                    </ul>
                </div>
            </div>
				<div class="portlet box blue">	
                   <div  class="portlet-title">   
                    <div class="caption"><i class="icon-reorder"></i>订单列表</div>
                        <div class="tools">
                        </div>    
                    </div>             
               <div class="portlet-body form" >
                    <div id="product">                                          
                        <table width="100%">
                             <tr height="45" style=" font-family:'微软雅黑'; font-size:14px; font-weight:500; color:#557abb;">
                                   <td width="5%">订单号</td>
                                   <td width="20%" style="text-align:center">订单提交者</td>
                                   <td width="12%" style="text-align:center">订单提交时间</td>
                    ...
                    <div class="portlet-body form"><input type="checkbox" name="allcheckbox" value="checkbox" onclick="javascript:select_all()" title="全选/取消">全选/取消 &nbsp;<input type="button" onClick="dellist(3,0)" value="删除选择项"/> <?php if(($reviewstatus != 0)): ?><input type="button" onClick="onelist('',<?php echo ($reviewstatus); ?>,3)" value="审核确认"/><?php endif; ?>                
...
function select_all()
{
	...
	if(allcheckbox.checked)
		...
		function onelist($id,$reviewstatus,$type)
		{
			...
			$.get('/ap_alter/beijing/order/o_cheks',{'id':$id,'reviewstatus':$reviewstatus},function(data){
