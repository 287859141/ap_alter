...
return array(
	//'配置项'=>'配置值'	
		...
		'MODULE_ALLOW_LIST' => array('Index','Langfang','Beijing'), //允许模块组,可增,以逗号为隔
		...
		'APP_SUB_DOMAIN_RULES'    =>    array(   
			'langfang.jinbaolian.com'  => 'Langfang',  // admin.domain1.com域名指向Admin模块
			'v.jinbaolian.com'  => 'Beijing',  // admin.domain1.com域名指向Admin模块
