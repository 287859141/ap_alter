...
<div class="portlet-body form">
    <form action="/ap_alter/beijing/member/m_add" class="horizontal-form" id="form_add" method="post" >						
        <div class="row-fluid">
            <div class="us_at ">
                <div class="control-group">                                                        
                    ...
                    <div class="us_box_ad">
                             <input type="text" id="name" name="name" class="m-wrap span12" placeholder="请输入账号">
                    </div>
                    <div class="txt_add"> <span class="help-block"><i class="icon-star" style="color:#F00;"></i>用户名以6位字母数字组合以字母开头</span></div>
                </div>
            </div>
        </div>
        <div class="row-fluid">
       ...
       <div class="row-fluid">
            <div class="us1 ">
                <div class="control-group">
                    ...
                    <div class="us_box_ad">
                             <input type="text"  id="rname" name="rname" class="m-wrap span12" placeholder="真实姓名"> 
                    </div>                                                            
        ...
        <div class="row-fluid">
            <div class="span6 ">
                <div class="control-group">
                    ...
                    <div class="us_box_ad">
                             <input type="text" id="department" name="department" class="m-wrap span12" placeholder="所属部门">
                    </div>                    
                ...
                <div class="control-group">
                    ...
                    <div class="us_box_ad"  >
                        <select class="span12 select2_category"  id="cpny" name="cpny" data-placeholder="请在这里选择一个角色权限" tabindex="1">                        
                            <?php if(is_array($lisc)): $i = 0; $__LIST__ = $lisc;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$company): $mod = ($i % 2 );++$i;?><option value="<?php echo ($company["id"]); ?>"   ><?php echo ($company["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                        </select>
                    </div>
                </div>
            </div>
        ...
        <div class="row-fluid">
            <div class="span6 ">
                <div class="control-group">
                    <div class="us_box">
                             <label class="user_name" >角色权限</label>
                    </div>
                    <div class="us_box_ad"  id="select_tab" >
                        <select class="span12 select2_category" id="select_tab" name="role" data-placeholder="请在这里选择一个角色权限" tabindex="1">                    
        ...
        <div class="row-fluid">
            <div class="span6 ">
                <div class="control-group">
                      ...
                      <div class="us_box_ad">
                           <input type="text" id="tel" name="tel" class="m-wrap span12"  placeholder="010-88888888/13888888888">
                      </div>                                                            
            ...
            <div class="row-fluid">    
                    <div class="span6 ">    
                        <div class="control-group">
                                ...
                                <input type="text" id="readdress" name="readdress" class="m-wrap span12"  placeholder="送货地址">     
                                </div>                            
                        </div>                         
...
function valdata(){		
		...
		var data= name.value;
		$.get('/ap_alter/beijing/member/check_name',{'username':name.value},function(data){
					//alert(data);
					if(data>=1)
					{
						 alert("用户名已存在");	
