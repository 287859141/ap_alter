...
<div class="portlet box blue">	
     ...
     <div  class="portlet-title">   
           ...
           <div class="caption"><i class="icon-reorder"></i>数据导出</div>

				<div class="more">&nbsp;

                     <form name=excel method=post action="/ap_alter/beijing/dates/importexcel">

                             <div class="cpadd">
                             <input type="submit" name="submit" value="导出结果为EXCEL文件" style="BACKGROUND-COLOR:red;BORDER-BOTTOM: #A6D683 1px solid; BORDER-LEFT: #A6D683 1px solid; BORDER-RIGHT: #A6D683 1px solid; BORDER-TOP: #A6D683 1px solid; COLOR: #FFFFFF;height:25px">	<?php if(($u_group == '9')OR($u_group == '15')OR($u_group == '81') OR($u_group == '82')): ?><input type="submit" name="byzhihang" value="导出按支行汇总EXCEL" style="BACKGROUND-COLOR:green;BORDER-BOTTOM: #A6D683 1px solid; BORDER-LEFT: #A6D683 1px solid; BORDER-RIGHT: #A6D683 1px solid; BORDER-TOP: #A6D683 1px solid; COLOR: #FFFFFF;height:25px"><?php endif; ?>

                                        	<input type="submit" name="bychanpin" value="导出按产品汇总EXCEL" style="BACKGROUND-COLOR:green;BORDER-BOTTOM: #A6D683 1px solid; BORDER-LEFT: #A6D683 1px solid; BORDER-RIGHT: #A6D683 1px solid; BORDER-TOP: #A6D683 1px solid; COLOR: #FFFFFF;height:25px">

                                        </div>

                    <input type="hidden" name="company" value="<?php echo ($company); ?>">

                    <input type="hidden" name="SelectedCuser_all" value="<?php echo ($clientuser); ?>">

                    <input type="hidden" name="SelectedCuser" value="<?php echo ($SelectedCuser); ?>">

                    <input type="hidden" name="SelectedProduct_all" value="<?php echo ($clientproduct); ?>">

                    <input type="hidden" name="SelectedProc" value="<?php echo ($SelectedProc); ?>">

                    <input type="hidden" name="Selectedstatus_all" value="<?php echo ($clientorder); ?>">
     ...
     <div id="product">                                          
           ...
           <table width="100%">
                   ...
                   <tr height="45" style=" font-family:'微软雅黑'; font-size:14px; font-weight:500; color:#557abb;">
                       ...
                       <td width="15%" style="text-align:center">订货部门</td>

                   </tr>

                   <?php if(is_array($search_list)): $i = 0; $__LIST__ = $search_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$search_list): $mod = ($i % 2 );++$i;?><tr id="user_table">

                      <td height="45" ><?php echo (date("Y-m-d H:i",$search_list['starttime'])); ?></td>

                      <td height="45" style="text-align:center" ><?php echo ($search_list["ordernum"]); ?></td>

                      <td height="45" style="text-align:center"><?php echo ($search_list["status"]); ?></td>

                      <td height="45" style="text-align:left"><?php echo ($search_list["prefix"]); ?>-<?php echo ($search_list["number"]); ?></td>

                      <td height="45" style="text-align:center" ><?php echo ($search_list["name"]); ?></td>

                      <td height="45"  style="text-align:center" ><?php echo ($search_list["baozhuang"]); ?></td>

                      <td height="45" style="text-align:center" ><?php echo ($search_list["danwei"]); ?></td>

                      <td height="45"  style="text-align:center" ><?php echo ($search_list["price"]); ?></td>

                      <td height="45"  style="text-align:center" ><?php echo ($search_list["amount"]); ?></td>

                      <td height="45"  style="text-align:center" ><?php echo ($search_list["allprice"]); ?></td>

                      <td class="user_edit" style="text-align:center" height="45"  ><?php echo ($search_list["department"]); ?></td>                  </tr><?php endforeach; endif; else: echo "" ;endif; ?>                                                  
    ...
    <div class="showamount_at">
         ...
         <div class="showamount_txt">库存数量</div>
            ...
            <div class="showamount_selt">
             ...
             <input type="text" id="chgnum_nums" class="showamount_sint" value="">
